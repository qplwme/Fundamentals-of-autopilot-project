...
PlotLog(X_log(:, 1:i),U_log(:, 1:i),Y,track_origin,track2_origin,i,Ts)

traj_mpcc = X_log(1:2,1:i)*scale;
...
traj_mpcc = [traj_mpcc; phi_mpcc; curv_mpcc];

save("traj_mpcc.mat", "traj_mpcc")